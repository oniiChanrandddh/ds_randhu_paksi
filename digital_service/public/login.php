...
<head>
<meta charset="UTF-8">
<title>Masuk | DigitalService</title>

<link rel="stylesheet" href="<?= $BASE_URL ?>public/assets/styles/user/auth/login.css">
...
<div class="auth-wrapper">
    <form action="<?= $BASE_URL ?>public/actions/login_process.php" method="POST" class="auth-box">
        <h2>Masuk</h2>
        <p class="subtitle">Masukkan username & password anda</p>
        ...
        <p class="link">
            Belum punya akun?
            <a href="<?= $BASE_URL ?>public/register.php">Daftar</a>
        </p>
    </form>
</div>
